...
TEMPLATE_TEST_CASE_SIG("SparseCoeffDiagonalMatrixBlock", "[SparseCoeffDiagonalMatrixBlock]", ((int BR, int BC, int NBR, int NBC), BR, BC, NBR, NBC),
...
)
{
  ...
  using MatT = mat::SparseCoeffDiagonalMatrixBlock<double, mat::ColMajor, BR, BC, NBR, NBC>;
...
TEMPLATE_TEST_CASE_SIG("SparseCoeffDiagonalMatrixBlock-Square", "[SparseCoeffDiagonalMatrixBlock]", ((int BR, int NBR), BR, NBR),
  (camSize, numCams),
  (camSize, mat::Dynamic),
  (mat::Dynamic, numCams),
...
)
{
  ...
  using MatT = mat::SparseCoeffDiagonalMatrixBlock<double, mat::ColMajor, BR, BR, NBR, NBR>;
...
TEMPLATE_TEST_CASE_SIG("SparseCoeffDiagonalMatrixBlock-Var", "[SparseCoeffDiagonalMatrixBlock]", ((int NBR, int NBC), NBR, NBC),
  (numCams, numPoints),
  (numCams, mat::Dynamic),
...
{
  using MatT = mat::SparseCoeffDiagonalMatrixBlock<double, mat::ColMajor, mat::Variable, mat::Variable, NBR, NBC>;
  std::unique_ptr<MatT> mat;
  SECTION("default ctor") {
    mat.reset(new MatT());
    REQUIRE(mat->numBlocksRow() == (NBR == mat::Dynamic ? 0 : NBR));
...
TEMPLATE_TEST_CASE_SIG("SparseCoeffDiagonalMatrixBlock-Square", "[SparseCoeffDiagonalMatrixBlock]", ((int NBR), NBR),
  (numCams),
  (mat::Dynamic)
)
{
  using MatT = mat::SparseCoeffDiagonalMatrixBlock<double, mat::ColMajor, mat::Variable, mat::Variable, NBR, NBR>;
  std::unique_ptr<MatT> mat;
  SECTION("default ctor") {
    mat.reset(new MatT());
    REQUIRE(mat->numBlocksRow() == (NBR == mat::Dynamic ? 0 : NBR));
